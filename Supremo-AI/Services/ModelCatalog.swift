...
struct ModelCatalog {
    static let featured: [DownloadableModel] = [
        ...
        model("RNJ 1 Instruct", url: "https://huggingface.co/lmstudio-community/rnj-1-instruct-GGUF", versionPrefix: "rnj-1-instruct", inference: .gemma),
        model("Ministral 3 3B Instruct", url: "https://huggingface.co/lmstudio-community/Ministral-3-3B-Instruct-2512-GGUF", versionPrefix: "Ministral-3-3B-Instruct-2512", inference: .mistral),
        model("NSFW 13B SFT", url: "https://huggingface.co/mzwing/NSFW_13B_sft-GGUF", versionPrefix: "NSFW_13B_sft", inference: .baichuan),
        model("Phi-3.5 mini instruct", url: "https://huggingface.co/bartowski/Phi-3.5-mini-instruct-GGUF", versionPrefix: "Phi-3.5-mini-instruct", inference: .phi),
