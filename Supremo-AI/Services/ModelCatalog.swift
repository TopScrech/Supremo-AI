...
struct ModelCatalog {
    static let featured: [DownloadableModel] = [
        ...
        model(familyName: "NSFW 13B SFT", fileName: "NSFW_13B_sft.Q2_K.gguf", urlString: "https://huggingface.co/mzwing/NSFW_13B_sft-GGUF/resolve/main/NSFW_13B_sft.Q2_K.gguf?download=true", quantization: "Q2_K", inference: .baichuan),
